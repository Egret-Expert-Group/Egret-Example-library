//libs:egret
//resources:resource/assets/cartoon-egret_00.png
//docs:本示例基于画弧 api，实现圆形遮罩功能。
//name:030-graph-dive-arc
var GraphicsDrawArcHigh = (function (_super) {
    __extends(GraphicsDrawArcHigh, _super);
    function GraphicsDrawArcHigh() {
        _super.call(this);
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=GraphicsDrawArcHigh,p=c.prototype;
    ...
    return GraphicsDrawArcHigh;
}(egret.DisplayObjectContainer));
egret.registerClass(GraphicsDrawArcHigh,'GraphicsDrawArcHigh');
