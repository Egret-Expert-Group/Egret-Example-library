...
//resources:resource/assets/particle3,resource/fire.res.json
//docs:粒子示例，篝火。
//name:150-particle-3
var ParticleBall = (function (_super) {
    __extends(ParticleBall, _super);
    function ParticleBall() {
        _super.call(this);
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=ParticleBall,p=c.prototype;
...
egret.registerClass(ParticleBall,'ParticleBall');
