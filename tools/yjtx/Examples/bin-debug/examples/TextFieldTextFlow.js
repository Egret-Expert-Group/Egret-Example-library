...
//name:110-text-text-flow-2
var TextFieldTextFlow = (function (_super) {
    __extends(TextFieldTextFlow, _super);
    function TextFieldTextFlow() {
        _super.call(this);
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=TextFieldTextFlow,p=c.prototype;
    ...
    return TextFieldTextFlow;
}(egret.DisplayObjectContainer));
egret.registerClass(TextFieldTextFlow,'TextFieldTextFlow');
