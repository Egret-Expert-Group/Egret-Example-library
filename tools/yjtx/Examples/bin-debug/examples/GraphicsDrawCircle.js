//libs:egret
//resources:
//docs:绘制圆形矢量，点击舞台，会在点击位置出现一个随机圆。
//name:030-graph-circle
var GraphicsDrawCircle = (function (_super) {
    __extends(GraphicsDrawCircle, _super);
    function GraphicsDrawCircle() {
        _super.call(this);
        this.shape = new egret.Shape();
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=GraphicsDrawCircle,p=c.prototype;
    ...
    return GraphicsDrawCircle;
}(egret.DisplayObjectContainer));
egret.registerClass(GraphicsDrawCircle,'GraphicsDrawCircle');
