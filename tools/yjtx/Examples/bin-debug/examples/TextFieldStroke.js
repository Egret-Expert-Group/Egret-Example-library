//libs:egret
//resources:
//docs:文本描边设置，通过设置 stroke 以及 strokeColor 来设置描边的粗细、颜色。\n触摸舞台更改文本字体描边粗细以及颜色值。
//name:110-text-stroke
var TextFieldStroke = (function (_super) {
    __extends(TextFieldStroke, _super);
    function TextFieldStroke() {
        _super.call(this);
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=TextFieldStroke,p=c.prototype;
...
egret.registerClass(TextFieldStroke,'TextFieldStroke');
