...
//resources:
//docs:富文本标准格式使用方式。
//name:110-text-text-flow-1
var TextFieldTextFlowByArray = (function (_super) {
    __extends(TextFieldTextFlowByArray, _super);
    function TextFieldTextFlowByArray() {
        _super.call(this);
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=TextFieldTextFlowByArray,p=c.prototype;
    ...
    return TextFieldTextFlowByArray;
}(egret.DisplayObjectContainer));
egret.registerClass(TextFieldTextFlowByArray,'TextFieldTextFlowByArray');
