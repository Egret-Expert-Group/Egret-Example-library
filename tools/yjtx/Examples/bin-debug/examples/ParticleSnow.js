...
//resources:resource/assets/particle2,resource/silver.res.json
//docs:粒子示例，摇钱树。\n点击后触发掉钱粒子效果。
//name:150-particle-2
var ParticleSnow = (function (_super) {
    __extends(ParticleSnow, _super);
    function ParticleSnow() {
        _super.call(this);
        this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
    }
    var d = __define,c=ParticleSnow,p=c.prototype;
...
egret.registerClass(ParticleSnow,'ParticleSnow');
